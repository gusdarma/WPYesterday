...
function yesterday_custom_settings() {
    ...
    register_setting( 'yesterday-setting-group', 'handler_twitter' );
    register_setting( 'yesterday-setting-group', 'handler_facebook' );
    register_setting( 'yesterday-setting-group', 'handler_instagram' );

    add_settings_section( 'yesterday-sidebar-options', 'Sidebar Options', 'yesterday_sidebar_options', 'yesterday' );
...
function yesterday_sidebar_options() {
    echo '<p>Customize your sidebar here</p>';  
}
